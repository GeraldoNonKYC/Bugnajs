...
module.exports = class walletNode extends EventEmitter {
  constructor (nodeAddress, readyCallback) {
    ...
    const packageDefinition = protoLoader.loadSync(__dirname + '/../protos/bugnawalletd.proto', {
      keepCase: true,
      longs: String,
      enums: String,
      defaults: true,
      oneofs: true
		...
		const { bugnawalletd } = gRPC.loadPackageDefinition(packageDefinition).bugnawalletd

    this._client = new bugnawalletd(nodeAddress, gRPC.credentials.createInsecure(), {  
